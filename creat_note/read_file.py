...
def read_notes(file_name):
    ...
    if not path_to_file.check_file(path_to_note):
        print("\033[31m Файла с таким именем {},не существует".format(path_to_note))
...
def get_note_number(file_name):
    ...
    try:
        ...
        return f"\033[31m Ключа с таким именем {error},не существует, вы удалили первую строку"
...
def show_all(file_name):
    ...
    try:
        ...
        print(f"\033[31m Ключа с таким именем {error},не существует, вы удалили первую строку")


# file_name = "note555"
# show_all(file_name)
# n = get_note_number(file_name)
# print(n)
# print(get_current_note(file_name, n))

# num = get_note_number(file_name)
# get_current_note(file_name, num)
